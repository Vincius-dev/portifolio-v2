      ...
      <main className="flex justify-center flex-col items-center mt-10 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        <div className="w-full flex flex-col sm:flex-row justify-center items-center">
          <div className="w-2/5 items-center sm:w-full">
            <Image src="/perfil.png" alt="Profile Picture" width={450} height={450} className="rounded-2xl lg:mx-auto md:lg:mx-auto sm:n-2" /> {/* Add mx-auto class to center the image */}
          </div>
