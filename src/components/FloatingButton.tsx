...
export default function FloatingButton() {
    return (
      <div className = "group fixed bottom-0 left-0 p-2 ml-12 flex items-end justify-start w-48 h-24 ">
      <div className = "text-white shadow-xl flex items-center justify-center p-3 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 z-50 absolute  ">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-12 h-12 group-hover:rotate-90 transition  transition-all duration-[0.6s]">
