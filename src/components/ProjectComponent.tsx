    ...
    return (
        <div className="lg:ml-24 ml-2">
            ...
            <div className="w-5/6 h-72 rounded-3xl shadow-md shadow-black dark:shadow-purple-600 inline-flex">
                ...
                <div className="lg:w-2/4 md:w-2/4 sm:w-3/4 p-4 sm:text-sm rounded-l-3xl sm:rounded-l-none md:rounded-l-none lg:rounded-l-none  rounded-r-3xl  bg-black dark:black text-white">
